...
class Config(object):
    # Bot Information 
    TECH_VJ_BOT_TOKEN = os.environ.get("TECH_VJ_BOT_TOKEN", "AAFYw6SD20I9iEh3q51DGH2LeQqRoqjt7d8")
    TECH_VJ_BOT_USERNAME = os.environ.get("TECH_VJ_BOT_USERNAME", "@Extractorsonubot") # Bot username without @.
    
    # The Telegram API things
    TECH_VJ_API_ID = int(os.environ.get("TECH_VJ_API_ID", "18579024"))
    TECH_VJ_API_HASH = os.environ.get("TECH_VJ_API_HASH", "124981da628d86e21ee492da77cd4037")
    ...
    TECH_VJ_OWNER_ID = int(os.environ.get("TECH_VJ_OWNER_ID", "574224129")) 
    TECH_VJ_SESSION_NAME = "VJ-URL-UPLOADER-BOT"
    
    # database uri (mongodb)
    TECH_VJ_DATABASE_URL = os.environ.get("TECH_VJ_DATABASE_URL", "mongodb+srv://vikassonawale765:s66otjHHOqz1NcRx@cluster0.yaji4.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")
    TECH_VJ_MAX_RESULTS = "50"

    # channel information
    TECH_VJ_LOG_CHANNEL = int(os.environ.get("TECH_VJ_LOG_CHANNEL", "-1002462529988")) # your log channel id and make bot admin in log channel with full right 
    ...
    TECH_VJ = bool(environ.get('TECH_VJ', FALSE)) # Set False If you want shortlink off else flase
